  ...
  (
    ...
    return (
      <div
        ...
        style={{ fontSize: "9pt", padding: "5mm", background: "white", color: "black" }}
      >
        ...
        <table style={{ width: "100%", marginBottom: "3mm", fontSize: "8px" }}>
          <tbody>
            <tr>
              <td style={{ width: "50%" }}>
                Data dokumentu: <strong>{format(documentDate, "dd.MM.yyyy")}</strong>
              </td>
              <td style={{ width: "50%" }}>
                Data operacji: <strong>{format(documentDate, "dd.MM.yyyy")}</strong>
              </td>
            </tr>
            <tr>
              <td>
                Okres: <strong>{format(documentDate, "MM/yyyy")}</strong>
              </td>
              <td>
                Waluta: <strong>{currency}</strong>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8px" }}>
          ...
          <tfoot>
            <tr style={{ borderTop: "2px solid #000", fontWeight: "bold" }}>
              <td colSpan={2} style={{ padding: "1px 2px", textAlign: "right" }}>
                Razem:
              </td>
