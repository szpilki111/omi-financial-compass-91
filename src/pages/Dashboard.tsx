...
const Dashboard = () => {
  ...
  const { data: locationInfo } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase.from("locations").select("name").eq("id", user.location).maybeSingle();
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-8">
          <Link to="/dokumenty">
            <Card>
              ...
              <CardContent>
                <CardDescription className="text-center">Tworzenie i przeglądanie dokumentów</CardDescription>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/reports">
            <Card>
              ...
              <CardContent>
                <CardDescription className="text-center">Generowanie raportów finansowych i analiz</CardDescription>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/budzet">
            <Card>
              ...
              <CardContent>
                <CardDescription className="text-center">Planowanie i realizacja budżetu</CardDescription>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/baza-wiedzy">
            <Card>
              ...
              <CardContent>
                <CardDescription className="text-center">Dokumenty, procedury, kalendarz i kontakty</CardDescription>
              </CardContent>
            </Card>
          </Link>
        </div>
